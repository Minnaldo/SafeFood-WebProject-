...
public class MemVO {
    ...
    public MemVO(String id, String pw, String name, String addr, String email, String tel, String alinfo, String foodlike) {
        //super();
        this.id = id;
        this.pw = pw;
        this.name = name;
